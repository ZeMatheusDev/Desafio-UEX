<template>
    <div class="auth-container">
      <div class="forgot-password-card">
        ...
        <div class="links">
          <button @click="submit()" class="button-submit">Editar Contato</button>
        </div>
        <div class="links">
  ...
  const form = useForm({
    ...
    cpf: formatCPF(props.contato.cpf),
    telefone: props.contato.telefone,
    cep: formatCEP(props.contato.cep),
    endereco: props.contato.endereco,
  ...
  function submit() {
    axios.post(route('update.contact'), form)
      .then(response => {
